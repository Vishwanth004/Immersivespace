...
import { ActionType, Actions, AppState, Modals } from "@spatialsys/web/app-state"
...
function* handleFirstQuestCompleted() {
  ...
  // Open the quest complete modal if the completed quest is the first quest space
  yield* put(Actions.openModal({ type: Modals.QuestComplete, payload: {} }))
}
