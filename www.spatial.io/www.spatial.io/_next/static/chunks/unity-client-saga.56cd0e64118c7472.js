    ...
    [1119, 6584], {
        ...
        34201: function(e, t, n) {
            ...
            var H = n(5632),
                ...
                et = n(69529),
                en = n(52322);
            let ei = (0, $.X5)(function(e) {
                let {
                    close: t,
                    unityAlert: n,
                    reply: i
                } = e, o = (0, ee.w)(null == n ? void 0 : n.linkHref, J.LP.Portal), r = e => {
            ...
            var eo = n(6277),
                ...
                es = n(82546),
                el = n.n(es);
            let ec = e => (0, en.jsxs)("div", {
                className: (0, eo.Z)(el().container, "p-4"),
                children: [(0, en.jsx)(et.X, {
                    size: "h2",
                    children: e.title
                }), (0, en.jsx)("p", {
                    className: "py-4",
                    ...
                    type: "button",
                    className: (0, eo.Z)(ea().textButton, "pr-8"),
                    onClick: e.onDeny,
                    children: e.denyText
                }), (0, en.jsx)("button", {
                    type: "button",
                    className: (0, eo.Z)(ea().textButton, "pt-4 text-blue"),
                    onClick: e.onConfirm,
            ...
            var eu = n(53083),
                ed = n(71594),
                eh = n(95051);
            let ep = ["hasUsedMouseOrKeyboard", "microphone/status", "roomSession/meetings", "roomSession/sessionDataSynced", "rtc/token"],
                em = {
                    app_finished_booting: function*() {
                        let e = yield*(0, m.w_)(e => e.user), t = yield(0, l.Ys)(e => e.auth);
                        p.finishBooting(), p.setWebUserAgent((0, Y.GI)(navigator.userAgent)), p.initializeAppStateObservers(ep), p.logIn(t.accessToken, t.useAuthlessToken, JSON.stringify(e.raw));
                        let n = new URLSearchParams(window.location.search);
                        e_(), yield(0, l.rM)(eb, n), ev(n), eS(n), yield(0, l.gz)(f.eX.setIsStarted(!0))
                    },
                            ...
                            switch (e.alertType) {
                                ...
                                case G.Km.NavigateWithHyperlink:
                                    (0, eh.v)(n => {
                                        ...
                                        return (0, en.jsx)(K.GH, {
                                            track: W.j,
                                            children: (0, en.jsx)(ei, {
                                                close: i,
                                                unityAlert: e,
                                                reply: t
                                            })
                                ...
                                default:
                                    ...
                                    ed.notifyConfirm({
                                        message: n => {
                                            ...
                                            return (0, en.jsx)(eu.Jz, {
                                                children: (0, en.jsx)(ec, {
                                                    title: e.title,
                                                    message: e.message,
                                                    denyText: e.deniedText,
                                                    confirmText: e.permitText,
                                        ...
                                        containerId: ed.InRoomContainerId,
                                        options: {
                                            toastId: n,
            ...
            function* ef(e) {
                let t = performance.now(),
                    ...
                    i = performance.now();
                if (!(null != n && n.name)) {
                    C.k.error(eg, "Received message without `name` property", {
                        message: n
                    });
                    return
                }
                if ("production" !== b.ZP.DEPLOYMENT_ENV && n.timing) {
                    ...
                    (null == e ? void 0 : e.treatments.recordReactBridgeTraces) === z.f7 && eC(n)
                }
                let o = em[n.name];
                if (!o) {
                    C.k.error(eg, "Unhandled message", {
                        message: n
                    });
                    return
                }
            ...
            function* ew(e, t, n, i) {
                ...
                let o = (0, d.GG)(e => (window.ReactUnityWebGL = {
                    ...
                    r = yield(0, l.v_)(i), a = eP(eP({}, e), {}, {
                        ...
                        startupErrorHandler: ek("SPATIAL_UNITY_FATAL_STARTUP_EXCEPTION"),
                        errorHandler: ek("SPATIAL_UNITY_FATAL_EXCEPTION")
                    });
                C.k.debug(eO, "Unity instance parameters", a);
                ...
                yield(0, l.RE)(p.setMessageSender, P), yield(0, l.rM)(h.Y6, o, ef), yield(0, l.rM)(eT), yield(0, l.rM)(j)
            }
...
//# sourceMappingURL=unity-client-saga.56cd0e64118c7472.js.map