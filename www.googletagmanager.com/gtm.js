...
(function() {
    ...
    */
    ...
    ne.ud = Number("0") || 0;
    ne.ia = "dataLayer";
    ne.Ki = "ChEI8ODbowYQz4Tci4Xh84GiARIkAFLyuygG35Ljk5k3pbETwfHZTjJ+jpN5QRponv15RxaTq4mrGgJ22g\x3d\x3d";
    var re = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var oj = lj,
        pj = "https://www.googletagmanager.com/a?id=" + T.C + "&cv=7";
    ...
    Z.o.hl = ["google"],
        function() {
            function a(f) {
                return f.target && f.target.location && f.target.location.href ? f.target.location.href : Jt()
            }
            ...
            function e() {
                ...
                return function(g) {
                    ...
                    m[l.source] = !0;
                    m[g.source] = !0;
                    if (!m.popstate || !m.hashchange || l.sa != g.sa) {
                        var n = {
                            event: "gtm.historyChange",
                            "gtm.historyChangeSource": g.source,
                            "gtm.oldUrlFragment": f.sa,
                            "gtm.newUrlFragment": g.sa,
        ...
        function() {
            (function(a) {
                ...
                if (!h(b) || 0 >= b.indexOf("-")) F(a.vtp_gtmOnFailure);
                    ...
                    var c = Wx(a.vtp_fieldsToSet, "name", "value") || {};
                    if (c.hasOwnProperty(N.g.Pa) || a.vtp_userProperties) {
                        var d = c[N.g.Pa] || {};
                        J(Wx(a.vtp_userProperties, "name", "value"), d);
                        c[N.g.Pa] = d
                    }
                    a.vtp_enableSendToServerContainer && a.vtp_serverContainerUrl &&
                        (c[N.g.vc] = a.vtp_serverContainerUrl, c[N.g.pe] = !0);
                    ...
                    $q(Wq(b, c), a.vtp_gtmEventId, {
                        noTargetGroup: !0,
                        originatingEntity: Lp(a.vtp_gtmEntityIndex, a.vtp_gtmEntityName)
                    });
        ...
        function() {
            ...
            function b(f, g, l) {
                    ...
                    p = function(u, v, w) {
                        ...
                        if (u) {
                            ...
                            for (var x = {}, y = 0; y < u.length; x = {
                                    Wb: x.Wb
                                }, y++) x.Wb = {}, k(u[y], function(B) {
                                return function(D, I) {
                                    w && "id" === D ? B.Wb.promotion_id = I : w && "name" === D ? B.Wb.promotion_name = I : B.Wb[D] = I
                                }
                            }(x)), m.items.push(x.Wb)
                        }
                        if (v)
                ...
                if (G(q)) {
                    var r = !1,
                        t;
                    for (t in q) q.hasOwnProperty(t) && (r || (c.push(5), r = !0), "currencyCode" === t ? n("currency", q.currencyCode) : "impressions" === t && g === N.g.Xa ? p(q.impressions, null) : "promoClick" === t && g === N.g.sb ? p(q.promoClick.promotions, q.promoClick.actionField, !0) : "promoView" === t && g === N.g.Ya ? p(q.promoView.promotions,
            ...
            (function(f) {
                ...
                if (h(g) && 0 === g.indexOf("G-")) {
                    ...
                    if (f.vtp_eventSettingsTable) {
                        var q = Wx(f.vtp_eventSettingsTable, "parameter", "parameterValue"),
                            r;
                        for (r in q) m[r] = q[r]
                    }
                    var t = Wx(f.vtp_eventParameters, "name",
                            "value"),
                        u;
                    for (u in t) t.hasOwnProperty(u) && (m[u] = t[u]);
                    var v = f.vtp_userDataVariable;
                    v && (m[N.g.oa] = v);
                    if (m.hasOwnProperty(N.g.Pa) || f.vtp_userProperties) {
                        var w = m[N.g.Pa] || {};
                        J(Wx(f.vtp_userProperties, "name", "value"), w);
                        m[N.g.Pa] = w
                    }
                    var x = {
                        originatingEntity: Lp(f.vtp_gtmEntityIndex, f.vtp_gtmEntityName)
                    };
                    if (0 < c.length) {
                        var y = {};
