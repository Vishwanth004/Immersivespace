...
import {
    NullComponent as DefaultUnsupportedAttachment
} from './UnsupportedAttachment';
import {
...
export var GalleryContainer = function(_a) {
    ...
    useLayoutEffect(function() {
        if (imageElements.current &&
            imageElements.current.every(function(element) {
                return !!element;
            }) &&
...
export var MediaContainer = function(props) {
    ...
    return ((_a = attachment.actions) === null || _a === void 0 ? void 0 : _a.length) ? (React.createElement(AttachmentWithinContainer, {
        ...
        React.createElement("div", {
            ...
            content,
            React.createElement(AttachmentActionsContainer, __assign({}, props))))) : (React.createElement(AttachmentWithinContainer, {
        attachment: attachment,
        componentType: componentType
    }, content));
};
export var UnsupportedAttachmentContainer = function(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(UnsupportedAttachment, {
            attachment: attachment
        })));
};